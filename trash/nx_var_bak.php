...
<?php
// Extract and store student roll numbers in a continuous list
$students = [];
...
// Track student index across all rooms
$seatIndex = 0;
?>
...
<div class="container mt-5">
    ...
    <?php if (!empty($bestRoom['room'])): ?>
        ...
        <?php foreach ($bestRoom['room'] as $room): ?>
            ...
            <div class="table-responsive">
                <?= generateSeatingArrangement($room, $students, $seatsPerBench, $seatIndex); ?>
            </div>
        <?php endforeach; ?>
...
function generateSeatingArrangement($room, &$students, $seatsPerBench, &$seatIndex) {
    ob_start();
